...
import ParticlesComponent from "./particles"; // Add particles in the background
  ...
  const loadModel = (modelFile) => {
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        gltf.scene.scale.set(2.2, 2.2, 2.2); // Updated scale to 2.2
  ...
  return (
    <div className="artifact-explorer">
      ...
      <div className="artifact-controls">
        <button onClick={handlePreviousModel} className="artifact-button">
          Previous
        </button>
        <button onClick={handleNextModel} className="artifact-button">
          Next
        </button>
      </div>
    </div>
