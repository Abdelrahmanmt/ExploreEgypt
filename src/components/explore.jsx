  ...
  const events = [
    {
      ...
      subtitle:
        "The Great Pyramids of Giza were built during Egypt's Old Kingdom, under Pharaohs Khufu, Khafre, and Menkaure. These monuments stand as a testament to ancient architectural skill and remain one of the Seven Wonders of the Ancient World.",
    },
    {
      ...
      subtitle:
        "Tutankhamun, the boy king of the 18th dynasty, ruled during the New Kingdom. He is most famous for his intact tomb, filled with treasures, which was discovered by Howard Carter in 1922.",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Cleopatra VII, the last ruler of the Ptolemaic Dynasty, played a key role in Roman politics. Her reign ended with her death in 30 BC, marking the conclusion of ancient Egyptian sovereignty.",
    },
  ];
